...
<head>
    ...
    <script src="/static/webuploader/js/jquery.js"></script>
    <link rel="stylesheet" href="/static/webuploader/css/xb-webuploader.css">
...
<script src="/static/webuploader/js/dist/webuploader.js"></script>
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: '/index/index/ajax_upload',
            // runtimeOrder: 'flash',
        ...
        function addFile(file) {
            var $li = $('<li id="' + file.id + '">' +
                ...
                '<input type="hidden" name="thumbs[]" value="' + file.name + '">' +
                '<p class="imgWrap"></p>' +
...
<script type="text/javascript" src="/static/webuploader/js/dist/webuploader.js"></script>
